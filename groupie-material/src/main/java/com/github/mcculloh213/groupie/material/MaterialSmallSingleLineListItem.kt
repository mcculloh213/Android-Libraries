...
import kotlinx.android.synthetic.main.item_single_line_small.*

open class MaterialSmallSingleLineListItem(
    private val text: String,
    @DrawableRes private val startIconRes: Int? = null,
    @DrawableRes private val endIconRes: Int? = null
) : MaterialListItem(R.layout.item_single_line_small) {
    @CallSuper
